...
if (isset($_REQUEST["xmlformat"]) && $_REQUEST["xmlformat"] == "xml")
{
	...
	for ($i = 0; $i < sizeof($uid_arr); $i++)
	{
		...
		*/
		...
		WHERE student_uid=".$db->db_add_param($student->prestudent_id)."
...
/*        $anzahl_fussnoten=0;
	...
	//		echo "<semesters>";
           ...
           $qry_semester=" Select distinct on(tbl_studiensemester.start, tbl_studiensemester.studiensemester_kurzbz) tbl_studiensemester.studiensemester_kurzbz, benotungsdatum as datum
...
//		die($qry_semester);
	...
	$start=0;
	foreach($semester_kurzbz as $row_semkurzbz)
	{
	$semester_ects=0;
	$start++;
	echo '<semesters>';
