			...
			<fo:flow  ><!--flow-name="xsl-region-body"-->
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Öffnen Sie mit ihrem Web-Browser die Adresse https://cis.sfu.ac.at/cis/public/accountactivation.php\n
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Zur Änderung Ihres Passwortes loggen Sie sich mit Ihrem Webbrowser auf https://cis.sfu.ac.at ein und wählen dem Menüpunkt 'Profil &gt; Passwort ändern'. \n
					</fo:block>
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Unser Webmail Service finden Sie hier: https://mail.uni.sfu.ac.at/SOGo/\n
Es ist derzeit eine Weiterleitung auf die uns bekannte Mail Adresse eingerichtet.\n
			  ...
			  <fo:block-container position="absolute" top="80mm" left="80mm">
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Open your web browser and go to https://cis.sfu.ac.at/cis/public/accountactivation.php\n
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Open your web browser and go to https://cis.sfu.ac.at. Enter your user name (Account) and password, select "Profile &gt; Change Password" from the pane on the left and follow the instructions.\n
					</fo:block>
