...
<xsl:apply-templates select="lehrende"/>
        ...
        <table:table-row table:style-name="Tabelle1.1">
          <table:table-cell table:style-name="Tabelle1.A4" table:number-columns-spanned="6" office:value-type="string">
...
<table:table-row table:style-name="Tabelle1.5">
  ...
  <table:table-cell table:style-name="Tabelle1.A6" office:value-type="string">
    <text:p text:style-name="P9"><xsl:value-of select="semester" /><xsl:value-of select="verband" /><xsl:value-of select="gruppe" /></text:p>
  </table:table-cell>
  <table:table-cell table:style-name="Tabelle1.A6" office:value-type="string">
    <text:p text:style-name="P6"/>
  </table:table-cell>
