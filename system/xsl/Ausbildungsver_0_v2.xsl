...
<xsl:template match="ausbildungsvertrag">
    <office:text text:use-soft-page-breaks="true">
      ...
      <text:p text:style-name="P11">
        <text:span text:style-name="T3">Studienbeginn WS 2016/17</text:span>
      </text:p>
      ...
      <text:p text:style-name="P11">
        <text:span text:style-name="T12">Verpflichtungen des Studierenden</text:span>
      </text:p>
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">(1) Der Studierende verpflichtet sich zur aktiven Teilnahme an den Lehrveranstaltungen des Curriculums, sowie zur Einhaltung allfälliger Regelbestimmungen der Universität.</text:span>
      </text:p>
      <text:p text:style-name="P23"/>
      <text:p text:style-name="P17">
        <text:span text:style-name="T4">(2) Im Hinblick auf die Tätigkeit oder Studien bei Praktika besteht für den Studierenden die Verpflichtung zur Verschwiegenheit entsprechend den Bestimmungen der jeweiligen Einrichtung sowie nach den einschlägigen Bestimmungen des Datenschutzgesetzes.</text:span>
      </text:p>
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P17">
        <text:span text:style-name="T4">(3) Der Universität steht an allen Arbeits- und Forschungsergebnissen des Studierenden, bzw. an allen solchen, an denen er beteiligt ist und die im Rahmen und im Zusammenhang mit dem Studium erzielt werden, ein uneingeschränktes und unentgeltliches Nutzungsrecht zu.</text:span>
      </text:p>
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P8">
        <text:span text:style-name="T4">(4) Der Studierende erklärt, die Verpflichtung zur Zahlung der Studiengebühren anzuerkennen und diese leisten zu können. Wird die Zahlungsverpflichtung von einer dritten Person übernommen, ist § 11 des Vertrages von dieser dritten Person auszufüllen und zu unterfertigen.</text:span>
      </text:p>
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P11">
      ...
      <text:list xml:id="list858979310221683130" text:style-name="WWNum23">
        ...
        <text:list-item>
          <text:p text:style-name="P34">
            <text:span text:style-name="T4">Der Studierende kann den Vertrag ohne Angabe von Gründen kündigen.</text:span>
          </text:p>
        </text:list-item>
        <text:list-item>
          <text:p text:style-name="P34">
      ...
      <text:list xml:id="list7623060826497902578" text:style-name="WWNum20">
        ...
        <text:list-item>
          <text:p text:style-name="P35">
            <text:span text:style-name="T4">Nichterreichen des Ausbildungszieles bzw. eines Teilausbildungszieles durch den Studierenden, wie im jeweiligen Curriculum festgelegt;</text:span>
          </text:p>
        </text:list-item>
        <text:list-item>
      ...
      <text:p text:style-name="P38">
        <text:span text:style-name="T13">Eine Überschreitung der Regelstudiendauer um zwei Semester ändert die Gesamt-gebühren nicht. Bei einer Überschreitung um mehr als zwei Semester behält sich die Universität das Recht vor, weitere Studiengebühren zu verrechnen (ausgenommen in begründeten Fällen wie z.B. Schwangerschaft, Krankheit).</text:span>
      </text:p>
      <text:p text:style-name="P15"/>
      <text:p text:style-name="P21">
        <text:span text:style-name="T13">Die Studiengebühren sind zu Beginn des Semesters fällig. Teilzahlungen sind möglich.</text:span>
      </text:p>
      ...
      <text:p text:style-name="P37">
        <text:span text:style-name="T5">Dem Studierenden wird seitens der Universität das Recht eingeräumt, nach positivem Abschluss des Bachelorstudiengangs der Rechtswissenschaften am daran anschließenden Masterstudiengang der Rechtswissenschaften teilzunehmen. Die Studiengebühr für den Masterstudiengang beträgt ebenfalls </text:span>
        <text:span text:style-name="T4">8.000,00 €</text:span>
        <text:span text:style-name="T5"> pro Semester valorisiert, wie im § 9 vereinbart. <text:line-break/></text:span>
      </text:p>
      <text:p text:style-name="P37">
      ...
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">Der Vertrag wird in zwei Exemplaren ausgefertigt, wovon der Studierende eine und die Universität eine Ausfertigung erhalten.</text:span>
      </text:p>
      <text:p text:style-name="P23"/>
        ...
        <table:table-row table:style-name="Tabelle1.1">
          <table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
            <text:p text:style-name="P9">
              <text:span text:style-name="T4">Wien, am <xsl:value-of select="datum_aktuell"/></text:span>
            </text:p>
      ...
      <text:p text:style-name="P10">
        <text:span text:style-name="T4">Für die Universität<text:tab/><text:tab/>Vorname Nachname</text:span>
      </text:p>
      <text:p text:style-name="P1"/>
      ...
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">Der/die Unterzeichnende erklärt mit Unterfertigung dieses Vertrages, den Verpflichtungen</text:span>
      </text:p>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">der Studierenden gemäß § 9 Gebühren dieses Vertrages beizutreten, sodass die</text:span>
      </text:p>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">Studierende sowie der/die Unterzeichnende mit Abgabe dieser Erklärung für sämtliche aus</text:span>
      </text:p>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">dieser Bestimmung resultierenden Zahlungsverbindlichkeiten der Studierenden zur</text:span>
      </text:p>
      <text:p text:style-name="P22">
        <text:span text:style-name="T4">ungeteilten Hand haften.</text:span>
      </text:p>
      <text:p text:style-name="P23"/>
      <text:p text:style-name="P23"/>
      <text:p text:style-name="P23"/>
      ...
      <text:p text:style-name="Standard">
        <text:span text:style-name="T8">der/die Beitretende<text:tab/><text:tab/><text:tab/><text:tab/> <text:s text:c="26"/>der/die Beitretende</text:span>
      </text:p>
      <text:p text:style-name="Standard">
        <text:span text:style-name="T16">Vorname und Nachname in Blockbuchstaben</text:span>
        <text:span text:style-name="T17"><text:tab/><text:tab/><text:tab/><text:s text:c="13"/>Unterschrift</text:span>
      </text:p>
      <text:p text:style-name="P5"/>
      <text:p text:style-name="P5"/>
