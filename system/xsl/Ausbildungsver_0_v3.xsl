...
<xsl:template match="ausbildungsvertrag">
    <office:text text:use-soft-page-breaks="true">
      ...
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P17">
        <text:span text:style-name="T4">(4) Der Student/ die Studentin erklärt, die Verpflichtung zur Zahlung der Studiengebühren anzuerkennen und diese leisten zu können. Wird die Zahlungsverpflichtung von einer dritten Person übernommen, ist § 11 des Vertrages von dieser dritten Person auszufüllen und zu unterfertigen.</text:span>
      </text:p>
      <text:p text:style-name="P12"/>
      <text:p text:style-name="P11">
