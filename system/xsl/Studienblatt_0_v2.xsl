            ...
            <table:table table:name="Tabelle1" table:style-name="Tabelle1">
                ...
                <table:table-row table:style-name="Tabelle1.1">
                    <table:table-cell table:style-name="Tabelle1.A1" table:number-columns-spanned="2" office:value-type="string">
                        ...
                        <text:p text:style-name="P8"><xsl:if test="titelpre != ''"><xsl:value-of select="titelpre"/><xsl:text> </xsl:text></xsl:if><xsl:value-of select="vorname"/> <xsl:value-of select="nachname"/><xsl:if test="titelpost != ''">, <xsl:value-of select="titelpost"/></xsl:if></text:p>
                    </table:table-cell>
                    <table:covered-table-cell/>
                    <table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
                        <text:p text:style-name="P10">Matrikelnummer</text:p>
            ...
            <table:table table:name="Tabelle2" table:style-name="Tabelle2">
                ...
                <table:table-row table:style-name="Tabelle2.1">
                    <table:table-cell table:style-name="Tabelle2.A1" table:number-columns-spanned="3" office:value-type="string">
                        ...
                        <text:p text:style-name="P8">Sigmund Freud PrivatUniversität Wien</text:p>
                    </table:table-cell>
                    <table:covered-table-cell/>
                    <table:covered-table-cell/>
                </table:table-row>
                ...
                <table:table-row table:style-name="Tabelle4.1">
                    ...
                    <table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
                        ...
                        <text:p text:style-name="P5">
                            <text:span text:style-name="T1">MMag. Dr. Stefan Hampl</text:span>
                        </text:p>
                        <text:p text:style-name="P5">
                            <text:span text:style-name="T1">Vizerektor für Lehre</text:span>
                        </text:p>
                    </table:table-cell>
                </table:table-row>
            </table:table>
