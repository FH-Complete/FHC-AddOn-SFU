				...
				<fo:flow flow-name="xsl-region-body" >
					...
					<fo:block-container position="absolute" top="40pt" left="30pt" height="30pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="14pt">
							Inskriptionsbestätigung Sigmund Freud PrivatUniversität Wien
						</fo:block>
					</fo:block-container> 
					...
					<fo:block-container position="absolute" top="150pt" left="30pt" height="30pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
							Datum:<xsl:text> </xsl:text><xsl:value-of select="tagesdatum" /><xsl:text> </xsl:text>
                        </fo:block>
					</fo:block-container> 

					<fo:block-container position="absolute" top="150pt" left="360pt" height="20pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
...
<!-- Abschnitt 2  -->
					...
					<fo:block-container position="absolute" top="300pt" left="360pt" height="20pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
							Vizerektor für Lehre: MMag. Dr. Stefan Hampl\n
                            gilt auch ohne Unterschrift und Stempel
                        </fo:block>
...
<!-- Abschnitt 3  -->
					...
					<fo:block-container position="absolute" top="450pt" left="360pt" height="20pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
							Vizerektor für Lehre: MMag. Dr. Stefan Hampl\n
                            gilt auch ohne Unterschrift und Stempel
                        </fo:block>
...
<!-- Abschnitt 4  -->
					...
					<fo:block-container position="absolute" top="600pt" left="360pt" height="20pt">
						<fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
							Vizerektor für Lehre: MMag. Dr. Stefan Hampl\n
                            gilt auch ohne Unterschrift und Stempel
						</fo:block>
...
<!-- Abschnitt 5  -->
					...
					<fo:block-container position="absolute" top="750pt" left="360pt" height="20pt">
                            <fo:block text-align="left" line-height="12pt" font-family="sans-serif" font-size="8pt">
								Vizerektor für Lehre: MMag. Dr. Stefan Hampl\n
                                gilt auch ohne Unterschrift und Stempel
							</fo:block>
