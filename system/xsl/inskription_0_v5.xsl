    ...
    <xsl:template match="student">
        <office:text xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
            ...
            <text:p text:style-name="P20">
                <draw:frame draw:style-name="fr1" draw:name="Bild1" text:anchor-type="paragraph" svg:x="13.861cm" svg:y="-0.20cm" svg:width="4.004cm" svg:height="0.873cm" draw:z-index="0"><draw:image xlink:href="Pictures/100000000000099F000002199F3507DB.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/></draw:frame>
            ...
            <text:p text:style-name="P21">
                <draw:frame draw:style-name="fr1" draw:name="Bild2" text:anchor-type="paragraph" svg:x="13.861cm" svg:y="0.25cm" svg:width="4.004cm" svg:height="0.873cm" draw:z-index="1"><draw:image xlink:href="Pictures/100000000000099F000002199F3507DB.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/></draw:frame>
            ...
            <text:p text:style-name="P21">
                <draw:frame draw:style-name="fr1" draw:name="Bild3" text:anchor-type="paragraph" svg:x="13.861cm" svg:y="0.25cm" svg:width="4.004cm" svg:height="0.873cm" draw:z-index="2"><draw:image xlink:href="Pictures/100000000000099F000002199F3507DB.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/></draw:frame>
                <text:span text:style-name="T3">
                    <text:line-break/>Inskriptions</text:span>bestätigung <text:span text:style-name="T3">Sigmund Freud PrivatUniversität</text:span> Wien</text:p>
            ...
            <text:p text:style-name="P11">------------------------------------------------------------------------------------------------------------------------------------------------------------------------</text:p>
            <text:p text:style-name="P21">
                <draw:frame draw:style-name="fr1" draw:name="Bild4" text:anchor-type="paragraph" svg:x="13.861cm" svg:y="0.25cm" svg:width="4.004cm" svg:height="0.873cm" draw:z-index="3"><draw:image xlink:href="Pictures/100000000000099F000002199F3507DB.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/></draw:frame>
                <text:span text:style-name="T3">
                    <text:line-break/>Inskriptions</text:span>bestätigung <text:span text:style-name="T3">Sigmund Freud PrivatUniversität</text:span> Wien</text:p>
